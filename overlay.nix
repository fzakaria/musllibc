self: super: {
  ...
  umockdev =
    super.umockdev.overrideAttrs
    (finalAttrs: previousAttrs: {checkPhase = "";});

  libgudev =
    super.libgudev.overrideAttrs
    (finalAttrs: previousAttrs: {checkPhase = "";});

  pipewire = super.unstable.pipewire;

  dbus_cplusplus =
    super.dbus_cplusplus.overrideAttrs
  ...
  donothing = super.pkgsMusl.callPackage "${builtins.fetchTarball {
    url = "https://github.com/fzakaria/donothing/archive/refs/heads/main.zip";
    sha256 = "sha256:1a15fiz7jqmc4mjafsqqzmvq1gszqi99w8ncz2spxip2n3j9rm4q";
  }}/derivation.nix" {};
}
