...
$(LOBJS) $(LDSO_OBJS): CFLAGS_ALL += -fPIC -DSQLITE_DEFAULT_MEMSTATUS=0 -DSQLITE_OMIT_DECLTYPE=1 -DSQLITE_OMIT_PROGRESS_CALLBACK=1 -DSQLITE_OMIT_SHARED_CACHE=1 -DSQLITE_USE_URI=1 -DSQLITE_MAX_MMAP_SIZE=2000000000 -DSQLITE_DEFAULT_MMAP_SIZE=2000000000 -DSQLITE_THREADSAFE=0
